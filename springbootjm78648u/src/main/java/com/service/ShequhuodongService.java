...
public interface ShequhuodongService extends IService<ShequhuodongEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<ShequhuodongEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<ShequhuodongEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<ShequhuodongEntity> wrapper);
