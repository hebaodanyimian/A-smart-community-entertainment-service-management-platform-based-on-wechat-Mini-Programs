<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0 20px","margin":"20px auto 0 40px","borderColor":"#3b6885","borderRadius":"10px","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 40px)","fontSize":"16px","borderStyle":"solid"}'>
