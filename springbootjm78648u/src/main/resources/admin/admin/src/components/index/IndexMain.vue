<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 210px","margin":"0","position":"relative","background":"#f5f5f5","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 6px rgba(0, 0, 0, .3)","padding":"0 10px 0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"start","top":"5px","borderRadius":"10px","left":"40px","background":"#107ED6","width":"calc(100% - 40px)","fontSize":"16px","position":"inherit","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px 40px","margin":"0px auto 0 40px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#fff","display":"none","width":"calc(100% - 40px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
