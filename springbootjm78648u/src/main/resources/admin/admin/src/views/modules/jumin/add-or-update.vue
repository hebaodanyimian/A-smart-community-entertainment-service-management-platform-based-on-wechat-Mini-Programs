	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="兴趣爱好" prop="xingquaihao" >
					<el-input v-model="ruleForm.xingquaihao" placeholder="兴趣爱好" clearable  :readonly="ro.xingquaihao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="兴趣爱好" prop="xingquaihao" >
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `jumin/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
