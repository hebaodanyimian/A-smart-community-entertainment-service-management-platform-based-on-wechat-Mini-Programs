		...
		<view class="container" :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#E9E9E9","height":"auto"}'>
			...
			<view :style='{"padding":"20rpx","margin":"-80rpx 0 0","background":"none","width":"100%","position":"relative","height":"auto","zIndex":"9"}' class="detail-content">
				...
				<view :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#929292","textAlign":"right"}' class="lable">娱乐名称：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text" >{{detail.yulemingcheng}}</view>
				</view>
				<view :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#929292","textAlign":"right"}' class="lable">参与人数：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text" >{{detail.canyurenshu}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#929292","textAlign":"right"}'>项目类型：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.xiangmuleixing}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#929292","textAlign":"right"}'>开放时间：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.kaifangshijian}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#929292","textAlign":"right"}'>所在位置：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.suozaiweizhi}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view :style='{"width":"100%","background":"#fff","display":"flex"}'>
					<view :style='{"width":"100%","margin":"0 0 24rpx 0","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","justifyContent":"center","display":"flex","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="zan">
					...
					<view :style='{"width":"100%","margin":"0 0 24rpx 0","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","justifyContent":"center","display":"flex","height":"auto"}' class="detail-list-item" v-if="thumbsupFlag" @tap="zan">
						<view :style='{"padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#fff","textAlign":"right"}' class="lable">取消赞</view>
						<view :style='{"color":"#fff","lineHeight":"80rpx","fontSize":"28rpx"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"color":"#fff","lineHeight":"80rpx","fontSize":"28rpx"}' class="icon iconfont icon-zan10"></view>
					</view>
					<view :style='{"width":"100%","margin":"0 0 24rpx 0","background":"#F3F9FF","justifyContent":"center","display":"flex","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="cai">
					...
					<view :style='{"width":"100%","margin":"0 0 24rpx 0","background":"#F3F9FF","justifyContent":"center","display":"flex","height":"auto"}' class="detail-list-item" v-if="crazilyFlag" @tap="cai">
				...
				<view class="detail-list-item" :style='{"padding":"0","margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#FFFFFF","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#929292","textAlign":"right"}'>注意事项：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.zhuyishixiang}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#929292","textAlign":"right"}'>详情简介：</view>
					<view class="rich-text" :style='{"padding":"24rpx 24rpx 24rpx 0","margin":"0"}'>
						<rich-text :nodes="detail.xiangqingjianjie"></rich-text>
					</view>
				</view>


				<view class="time-content" :style='{"width":"100%","margin":"40rpx 0 24rpx 0","overflow":"hidden","borderRadius":"20rpx","background":"#fff","height":"auto"}'>
					<view class="comoment-header" :style='{"width":"100%","boxShadow":"rgb(0 0 0 / 30%) 0px 2rpx 12rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
						...
						<view :style='{"padding":"0 20rpx","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","display":"flex"}' @click="onCommentTap" class="btn-comment-content" style="display: flex;align-items: center;">
					...
					<view :style='{"boxShadow":"none","padding":"24rpx","margin":"24rpx auto 0","borderColor":"#3d4e81","borderRadius":"0","background":"#fff","borderWidth":"0 0 2rpx 0","width":"calc(100% - 40rpx)","position":"relative","borderStyle":"dashed","height":"auto"}' v-for="(item,index) in commentList" v-bind:key="index" class="cu-item comment-item">
						...
						<view :style='{"width":"100%","margin":"16rpx 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"60rpx"}'>
							...
							<view v-if="comzanChange(item)" :style='{"background":"none"}' @click="comzanClick(item)">
								<span class="icon iconfont icon-zan11" :style='{"color":"#3d4e81","fontSize":"28rpx"}'></span>
								<span :style='{"color":"#3d4e81","fontSize":"28rpx","display":"none"}'>已赞</span>
								<span :style='{"color":"#3d4e81","fontSize":"28rpx"}'>({{item.thumbsupnum}})</span>
							</view>
							...
							<view v-if="comcaiChange(item)" :style='{"background":"none"}' @click="comcaiClick(item)">
								<span class="icon iconfont icon-cai16" :style='{"color":"#3d4e81","fontSize":"28rpx"}'></span>
								<span :style='{"color":"#3d4e81","fontSize":"28rpx","display":"none"}'>已踩</span>
								<span :style='{"color":"#3d4e81","fontSize":"28rpx"}'>({{item.crazilynum}})</span>
							</view>
						</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"10rpx 24rpx","flexWrap":"wrap","background":"#FFFFFF","display":"flex","gap":"20rpx","width":"100%","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('yulexiangmu','立即参与')" @tap="onAcrossTap('canyuxinxi','','','[1]','已参与')" class="cu-btn bg-brown round shadow-blur" >立即参与</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('yulexiangmu','立即参与')" @tap="onAcrossTap('canyuxinxi','','','[1]','已参与')" class="cu-btn bg-brown round shadow-blur" >立即参与</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('yulexiangmu','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('yulexiangmu','私聊')" @tap="chatClick">联系TA</button>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			this.getStoreup();
			this.getThumbsup();
			let cleanType = uni.getStorageSync('discussyulexiangmuCleanType')
			if(cleanType){
				uni.removeStorageSync('discussyulexiangmuCleanType')
				this.mescroll.num = 1
			...
			if(crossCleanType) {
				...
				res = await this.$api.info('yulexiangmu', this.id);
				let reg=new RegExp('http://localhost:8080/springbootjm78648u/upload','g')//g代表全部
				if(res.data.xiangqingjianjie){
					res.data.xiangqingjianjie = res.data.xiangqingjianjie.replace(reg, this.$base.url + 'upload');
				}
				this.detail = res.data;
				this.title = this.detail.yulemingcheng
			}
		},
		destroyed: function() {
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','yulexiangmu');
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								...
								await _this.$api.update('yulexiangmu',_this.detail)
					...
					success: async function(res) {
						if (res.confirm) {
							await _this.$api.add('storeup', {
								userid: _this.user.id,
								name: _this.detail.yulemingcheng,
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','yulexiangmu');
			...
			async init(type=1){
				...
				let res = await this.$api.info('yulexiangmu', this.id);
				let reg=new RegExp('http://localhost:8080/springbootjm78648u/upload','g')//g代表全部
				res.data.xiangqingjianjie = res.data.xiangqingjianjie.replace(reg, this.$base.url + 'upload').replace(/<img/g,'<img style="width: 100%;"');
				this.detail = res.data;
				...
				//修改富文本的图片样式
				this.detail.xiangqingjianjie = this.detail.xiangqingjianjie.replace(/img src/gi,"img style=\"width:100%;\" src");
				...
				if(type==2){
					...
					await this.$api.update('yulexiangmu',this.detail)
				}
			},
			...
			async upCallback(mescroll) {
				if(uni.getStorageSync("appUserid")){
					let res = await this.$api.list('discussyulexiangmu', {
						page: mescroll.num,
						limit: 10,
			...
			async comzanClick(row){
				...
				if(!this.comzanChange(row)){
					...
					await this.$api.update('discussyulexiangmu',row)
					this.$utils.msg('点赞成功');
				}else {
					row.thumbsupnum--
					let arr = String(row.tuserids).split(',')
			...
			async onCommentTap() {
				...
				let res = {}
				this.$utils.jump(`../discussyulexiangmu/add-or-update?refid=${this.id}` )
			},
			delClick(id){
				let that = this
				uni.showModal({
					...
					async success(res) {
						if(res.confirm){
							await that.$api.del('discussyulexiangmu',JSON.stringify([id]))
							that.$utils.msg('删除成功')
							that.detail.discussnum--
							await that.$api.update('yulexiangmu',that.detail)
							setTimeout(()=>{
